...
export const PopupSuccess = () => import('../../components/PopupSuccess.vue' /* webpackChunkName: "components/popup-success" */).then(c => wrapFunctional(c.default || c))
...
export const AccountStarPointsBackup = () => import('../../components/account/StarPointsBackup.vue' /* webpackChunkName: "components/account-star-points-backup" */).then(c => wrapFunctional(c.default || c))
