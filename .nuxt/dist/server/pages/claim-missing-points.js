exports.ids = [29,12,13,14,19,21,26];
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/claim-missing-points.vue?vue&type=template&id=96936ea8&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_c('MainMenu'),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"container px-6 py-6 mx-auto md:py-14 md:px-0\">","</div>",[_vm._ssrNode("<div class=\"text-3xl font-semibold text-grayscale-900 font-noto-sans\">\n      Claim Missing Points\n    </div> <div class=\"mt-3 text-sm text-grayscale-500 md:text-base\">\n      Buy more Star Points to get the flight reward you really want. If you do not have enough Star Points for an award ticket, award upgrade on Star Air or extra baggage, you can buy additional Star Points to top up your existing balance online.\n    </div> <div class=\"block p-6 mt-10 md:hidden bg-light-blue rounded-xl\"><div class=\"text-lg font-semibold text-grayscale-900\">\n        Claim Missing Points Info\n      </div> <div class=\"mt-4 text-grayscale-500\"><ul class=\"pl-5 leading-loose list-disc\"><li>You may claim points that have not yet been credited to your account.</li> <li>Claims must only be submitted for flights taken within the past 6 months.</li> <li>Please allow time for the missing mileage to be reflected on your account.</li> <li>You should receive your updated mileage balance on your next StarPoints Statement.</li></ul></div></div> "),_vm._ssrNode("<div class=\"flex items-start mt-6 md:mt-16 gap-x-8\">","</div>",[_vm._ssrNode("<div class=\"md:w-2/3\">","</div>",[_c('Select',{attrs:{"label":"Membership Name"}}),_vm._ssrNode(" "),_c('Select',{attrs:{"label":"Passanger Ticket Number","customClass":"mt-6"}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"mt-10 md:w-64\">","</div>",[_c('NuxtLink',{attrs:{"to":""}},[_c('Button',{attrs:{"value":"Retrieve Flight"}})],1)],1),_vm._ssrNode(" <div class=\"my-10 border-b\"></div> <div class=\"text-lg font-semibold text-grayscale-900\">\n          Search Data Claim \n        </div> "),_c('Input',{attrs:{"label":"PNR or Payment Number","customClass":"mt-6","icon":"search.svg"}}),_vm._ssrNode(" <div class=\"\n            mt-6\n            md:px-0 md:-mx-0\n            px-6\n            -mx-6\n            md:w-full\n            w-[100vw]\n            overflow-auto\n          \"><table class=\"table-auto md:w-full custom-table w-[1200px]\"><thead><tr><th>No</th> <th>PNR</th> <th>Origin</th> <th>Destination</th> <th>Status</th> <th>Action</th> <th></th></tr></thead> <tbody>"+(_vm._ssrList((5),function(index){return ("<tr><td>"+_vm._ssrEscape(_vm._s(index))+"</td> <td>ASD1234</td> <td>New Delhi (DEL)</td> <td>Indore (IDR)</td> <td>Pending</td> <td>Claim</td> <td><img"+(_vm._ssrAttr("src",__webpack_require__(38)))+" alt=\"Info\" class=\"inline-block\"></td></tr>")}))+"</tbody> <tfoot><tr><th colspan=\"3\">Show 1 to 5 of 56 entries:</th> <th colspan=\"4\" class=\"text-right\"><div class=\"flex justify-end gap-x-10\"><div class=\"flex-none\">1</div> <div class=\"flex-none\">2</div> <div class=\"flex-none\">3</div> <div class=\"flex-none\">4</div> <div class=\"flex-none\">Next</div></div></th></tr></tfoot></table></div>")],2),_vm._ssrNode(" <div class=\"hidden w-1/3 p-6 md:block bg-light-blue rounded-xl\"><div class=\"text-lg font-semibold text-grayscale-900\">\n          Claim Missing Points Info\n        </div> <div class=\"mt-4 text-grayscale-500\"><ul class=\"pl-5 leading-loose list-disc\"><li>You may claim points that have not yet been credited to your account.</li> <li>Claims must only be submitted for flights taken within the past 6 months.</li> <li>Please allow time for the missing mileage to be reflected on your account.</li> <li>You should receive your updated mileage balance on your next StarPoints Statement.</li></ul></div></div>")],2)],2),_vm._ssrNode(" "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/claim-missing-points.vue?vue&type=template&id=96936ea8&

// CONCATENATED MODULE: ./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/claim-missing-points.vue?vue&type=script&lang=ts&

/* harmony default export */ var claim_missing_pointsvue_type_script_lang_ts_ = ({
  name: "ClaimMissingPoints",
  data() {
    return {};
  },
  methods: {},
...
// CONCATENATED MODULE: ./pages/claim-missing-points.vue?vue&type=script&lang=ts&
 /* harmony default export */ var pages_claim_missing_pointsvue_type_script_lang_ts_ = (claim_missing_pointsvue_type_script_lang_ts_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./pages/claim-missing-points.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_claim_missing_pointsvue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var claim_missing_points = __webpack_exports__["default"] = (component.exports);

/* nuxt-component-imports */
installComponents(component, {Header: __webpack_require__(94).default,MainMenu: __webpack_require__(95).default,Select: __webpack_require__(93).default,Button: __webpack_require__(32).default,Input: __webpack_require__(29).default,Footer: __webpack_require__(96).default})


/***/ })
]);;
//# sourceMappingURL=claim-missing-points.js.map