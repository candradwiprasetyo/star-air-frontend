exports.ids = [29,12,13,14,19,20,21];
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/activation.vue?vue&type=template&id=3294f288&
...
// CONCATENATED MODULE: ./pages/activation.vue?vue&type=template&id=3294f288&
            ...
            this.$axios.$post('/member/get-member-detail', formDataDetail)
              .then( (responseDetail) => {
                if (response.err_num == '0') {
                  ...
                  external_js_cookie_default.a.set('star_air_login', JSON.stringify(responseDetail.result));
                  this.$router.push('/');
                }
              })
...
/* nuxt-component-imports */
installComponents(component, {Header: __webpack_require__(101).default,MainMenu: __webpack_require__(102).default,InputPassword: __webpack_require__(104).default,Button: __webpack_require__(35).default,Footer: __webpack_require__(103).default})
