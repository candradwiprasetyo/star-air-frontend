...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/transfer-points-for-plus.vue?vue&type=template&id=1f2cea09&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_c('MainMenu'),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"container px-6 py-6 mx-auto md:py-14 md:px-0\">","</div>",[_vm._ssrNode("<div class=\"text-3xl font-semibold text-grayscale-900 font-noto-sans\">\n      Transfer Points for Plus\n    </div> <div class=\"mt-3 text-sm text-grayscale-500 md:text-base\">\n      Share your Star Points with another Star Club member such as friend and family. So that they can also enjoy travelling with you. Transfer Points for Plus to other Star Club member can be done with minimum 1000 points.\n    </div> <div class=\"block p-6 mt-10 md:hidden bg-light-blue rounded-xl\"><div class=\"text-lg font-semibold text-grayscale-900\">\n        Transfer Points for Plus Information\n      </div> <div class=\"mt-4 text-grayscale-500\"><ul class=\"pl-5 leading-loose list-disc\"><li>Star Points can be transferred in blocks of 1,000 Points</li> <li>You can transfer up to 250,000 Star Points per calendar year.</li> <li>The transfer of Star Points is non-refundable.</li></ul></div></div> "),_vm._ssrNode("<div class=\"flex items-start mt-6 md:mt-16 gap-x-8\">","</div>",[_vm._ssrNode("<div class=\"md:w-2/3\">","</div>",[_vm._ssrNode("<div class=\"flex\">","</div>",[_vm._ssrNode("<div class=\"flex-grow\">","</div>",[_c('Input',{attrs:{"label":"How many Points you want to transfer?","border":"border rounded-l-lg"}})],1),_vm._ssrNode(" <div class=\"flex-none p-3 rounded-r-lg w-28 bg-light-blue\"><div class=\"text-xs text-grayscale-400\">Points Balance</div> <div class=\"text-sm text-grayscale-900\">10500</div></div>")],2),_vm._ssrNode(" "),_c('Input',{attrs:{"label":"Recepient Name","customClass":"mt-6"}}),_vm._ssrNode(" "),_c('Input',{attrs:{"label":"Star Club Number","customClass":"mt-6"}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"mt-10 md:w-64\">","</div>",[_c('NuxtLink',{attrs:{"to":""}},[_c('Button',{attrs:{"value":"Continue"}})],1)],1)],2),_vm._ssrNode(" <div class=\"hidden w-1/3 p-6 md:block bg-light-blue rounded-xl\"><div class=\"text-lg font-semibold text-grayscale-900\">\n          Transfer Points for Plus Information\n        </div> <div class=\"mt-4 text-grayscale-500\"><ul class=\"pl-5 leading-loose list-disc\"><li>Star Points can be transferred in blocks of 1,000 Points</li> <li>You can transfer up to 250,000 Star Points per calendar year.</li> <li>The transfer of Star Points is non-refundable.</li></ul></div></div>")],2)],2),_vm._ssrNode(" "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/transfer-points-for-plus.vue?vue&type=template&id=1f2cea09&

// CONCATENATED MODULE: ./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/transfer-points-for-plus.vue?vue&type=script&lang=ts&

/* harmony default export */ var transfer_points_for_plusvue_type_script_lang_ts_ = ({
  name: "TransferPointsForPlus",
  data() {
    return {};
  },
  methods: {},
...
// CONCATENATED MODULE: ./pages/transfer-points-for-plus.vue?vue&type=script&lang=ts&
 /* harmony default export */ var pages_transfer_points_for_plusvue_type_script_lang_ts_ = (transfer_points_for_plusvue_type_script_lang_ts_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./pages/transfer-points-for-plus.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_transfer_points_for_plusvue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var transfer_points_for_plus = __webpack_exports__["default"] = (component.exports);

/* nuxt-component-imports */
installComponents(component, {Header: __webpack_require__(94).default,MainMenu: __webpack_require__(95).default,Input: __webpack_require__(29).default,Button: __webpack_require__(32).default,Footer: __webpack_require__(96).default})


/***/ })
]);;
//# sourceMappingURL=transfer-points-for-plus.js.map