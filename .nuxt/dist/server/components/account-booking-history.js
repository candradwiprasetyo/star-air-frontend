...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/account/BookingHistory.vue?vue&type=template&id=3014ea98&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<div class=\"w-full pb-0 mb-6 border rounded-xl text-grayscale-500\">","</div>",[_vm._ssrNode("<div class=\"p-6 border-b\"><div class=\"flex\"><div class=\"text-lg font-semibold font-noto-sans text-grayscale-900\">Booking History</div></div></div> "),_vm._ssrNode("<div class=\"mx-6 mt-6 space-y-4 md:space-y-0 md:space-x-4 md:flex\">","</div>",[_vm._ssrNode("<div class=\"flex-grow\">","</div>",[_vm._ssrNode("<div class=\"space-y-4 md:space-y-0 md:space-x-4 md:flex\">","</div>",[_vm._ssrNode("<div class=\"flex-1\">","</div>",[_c('Input',{attrs:{"label":"Keyword"}})],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"flex-1\">","</div>",[_c('Select',{attrs:{"label":"Start Date"}})],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"flex-1\">","</div>",[_c('Select',{attrs:{"label":"End Date"}})],1)],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"flex-none\">","</div>",[_c('Button',{attrs:{"value":"Filter","border":"border-2 border-secondary-900","color":"text-secondary-900","background":"bg-white"}})],1)],2),_vm._ssrNode(" <div class=\"p-6 overflow-hidden\"><div class=\"\n          md:px-0 md:-mx-0\n          px-6\n          -mx-6\n          md:w-full\n          w-[100vw]\n          overflow-auto\n        \"><table class=\"table-auto md:w-full custom-table w-[1200px]\"><thead><tr><th>Booking Date</th> <th>Origin - Destination</th> <th>Flight Date</th> <th>Flight</th> <th>Action</th></tr></thead> <tbody>"+(_vm._ssrList((5),function(index){return ("<tr><td>19 Nov 2021, 08:50 AM</td> <td>Mumbai (BOM - Delhi (DEL)</td> <td>19 Nov 2021, 08:50 AM</td> <td>SA-1234</td> <td class=\"text-secondary-900\">Detail</td></tr>")}))+"</tbody> <tfoot><tr><th colspan=\"2\">Show 1 to 5 of 56 entries:</th> <th colspan=\"3\" class=\"text-right\"><div class=\"flex justify-end gap-x-10\"><div class=\"flex-none\">1</div> <div class=\"flex-none\">2</div> <div class=\"flex-none\">3</div> <div class=\"flex-none\">4</div> <div class=\"flex-none\">Next</div></div></th></tr></tfoot></table></div></div>")],2)])}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/account/BookingHistory.vue?vue&type=template&id=3014ea98&
