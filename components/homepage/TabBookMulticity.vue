...
export default {
  ...
  methods: {
    ...
    loadOrigin() {
      this.$axios.$get('https://ws-sg.sqiva.com/?rqid=H5KM9F6D-7ZG9-LBVE-S6ZE-7Y6XPDGBBLMG&airline_code=RS5&app=data&action=get_org')
        .then( (response) => {
    ...
    loadDestination() {
      this.$axios.$get('https://ws-sg.sqiva.com/?rqid=H5KM9F6D-7ZG9-LBVE-S6ZE-7Y6XPDGBBLMG&airline_code=RS5&app=data&action=get_org_des')
        .then( (response) => {
    ...
    loadAllDestination() {
      this.$axios.$get('https://ws-sg.sqiva.com/?rqid=H5KM9F6D-7ZG9-LBVE-S6ZE-7Y6XPDGBBLMG&airline_code=RS5&app=data&action=get_des')
        .then( (response) => {
