...
export default {
  ...
  methods: {
    ...
    loadOrigin() {
      this.$axios.$get('https://dev-api-portal.sqiva.com/v1/awan/relay-path/?airline_code=TROG&app=data_airline&action=get_org')
        .then( (response) => {
    ...
    loadDestination() {
      this.$axios.$get('https://dev-api-portal.sqiva.com/v1/awan/relay-path/?airline_code=TROG&app=data_airline&action=get_org_des')
        .then( (response) => {
    ...
    loadAllDestination() {
      this.$axios.$get('https://dev-api-portal.sqiva.com/v1/awan/relay-path/?airline_code=TROG&app=data_airline&action=get_des')
        .then( (response) => {
