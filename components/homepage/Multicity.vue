<template>
  <div class="flex w-full">
    ...
    <div class="flex w-full mt-6 md:w-1/6 md:mt-0">
      ...
      <div v-else-if="countIndex!=0" class="flex w-full gap-4 pl-4 text-secondary-900">
        <div class="flex-grow" v-if="isAddButton">
          <div 
            class="flex items-center justify-center w-full gap-3 py-5 font-medium text-center border-2 rounded-lg cursor-pointer border-secondary-900"
            @click="addCountData()"
          >
